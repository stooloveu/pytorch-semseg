    ...
    if cfg["training"]["resume"] is not None:
        if os.path.isfile(cfg["training"]["resume"]):
            ...
            if not args.load_weight_only:
                ...
                # pretrained_dict['module.model.convbnrelu1_1.cbr_unit.0.weight']
                # model_dict = model.state_dict()
                # model_dict['module.model.convbnrelu1_1.cbr_unit.0.weight'][:, 0:3, :, :] = pretrained_dict['module.model.convbnrelu1_1.cbr_unit.0.weight']
                # model_dict['module.model.convbnrelu1_sub1.cbr_unit.0.weight'][:, 0:3, :, :] = pretrained_dict['module.model.convbnrelu1_sub1.cbr_unit.0.weight']

                # # import ipdb
                # # ipdb.set_trace()
                # # 1. filter out unnecessary keys
                # pretrained_dict = {k: v for k, v in pretrained_dict.items() if k in model_dict and k != 'module.model.convbnrelu1_1.cbr_unit.0.weight' 
                #                                                                                and k != 'module.model.convbnrelu1_sub1.cbr_unit.0.weight'
                #                                                                                and 'cff_sub24_inst' not in k
                #                                                                                and 'cff_sub12_inst' not in k
                #                                                                                and 'inst_feature_embedding' not in k}
