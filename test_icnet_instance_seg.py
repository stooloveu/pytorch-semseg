...
def test(args):
    ...
    outputs_inst_transformed = outputs_inst.reshape((h * w, c))
    ...
    outputs_inst = outputs_inst_transformed.reshape((h, w, 3))
    outputs_inst = (outputs_inst * 256).astype(int)

    decoded = loader.decode_segmap(pred)
    print("Classes found: ", np.unique(pred))
    imageio.imsave(args.out_path, decoded)
    imageio.imsave("inst_"+args.out_path, outputs_inst)
