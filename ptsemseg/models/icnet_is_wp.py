...
class icnet_is_wp(nn.Module):
    ...
    def __init__(
        ...
        super(icnet_is_wp, self).__init__()
    ...
    def forward(self, x):
        ...
        x_sub2 = get_coord_map(x_sub2, scale = 0)
        ...
        #saving memory
        x_sub4 = x_sub4_inst
        x_sub1 = get_coord_map(x)
        x_sub1 = self.convbnrelu1_sub1(x_sub1)
